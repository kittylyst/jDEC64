...
public class SimpleTest {
  ...
  public void test_Less() {
    assertTrue(
        less(TestConstants.MINIMUM, TestConstants.MAXIMUM), "minimum should be less than maximum");
    assertTrue(less(Constants64.DEC64_ZERO, Constants64.DEC64_ONE), "0 should be less than 1");
    assertTrue(
        less(TestConstants.ALMOST_ONE, Constants64.DEC64_ONE), "0.9... should be less than 1");
    ...
    assertFalse(
        less(TestConstants.MAXIMUM, TestConstants.MINIMUM),
        "maximum should not be less than minimum");
    assertFalse(
        less(Constants64.DEC64_ONE, Constants64.DEC64_NEGATIVE_ONE),
        "1 should not be less than -1");
    assertFalse(less(TestConstants.THREE, TestConstants.THREE), "3 should not be less than 3");
    assertFalse(
        less(TestConstants.EPSILON, TestConstants.MINIMUM),
        "epsilon should not be smaller than minimum");
    assertFalse(
        less(Constants64.DEC64_TWO, TestConstants.TWO_EPSILON), "2 should not be less than 2e-16");
    assertFalse(less(TestConstants.FOUR, Constants64.DEC64_PI), "4 should not be less than PI");
    assertFalse(
        less(TestConstants.FOUR, of(20, (byte) -128)), "illegal exponent should return false");
    assertFalse(
        less(TestConstants.FOUR, Constants64.DEC64_NAN),
        "Any nan value is greater than any number value");
  }
}

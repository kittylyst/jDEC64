...
//		assertTrue("neg value of 1 should equal -1", equals64(neg(DEC64_ONE), DEC64_NEGATIVE_ONE));
    ...
    void testLess() {        
        ...
        assertFalse(less(FOUR, of(20, (byte) -128)), "illegal exponent should return false");
    ...
    void testCeiling() {
        ...
        //assertEquals(DEC64_ZERO, ceiling(NEGATIVE_EPSILON), "It should return zero for negative epsilon argument");
    ...
    void testFloor() {
        ...
        //assertEquals(DEC64_NEGATIVE_ONE, floor(NEGATIVE_EPSILON), "It should return negative one for negative epsilon argument");
    }
}

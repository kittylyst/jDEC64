...
//    static private @DEC64 long e = DEC64_E;
    ...
    private static void test_acos(@DEC64 long DEC64_NEGATIVE_ONE, @DEC64 long pi, String msg) {
    ...
    private static void test_atan(@DEC64 long cent, @DEC64 long of, String msg) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private static void test_cos(@DEC64 long cent, @DEC64 long of, String msg) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private static void test_exp(@DEC64 long one, @DEC64 long e, String msg) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private static void test_factorial(@DEC64 long one, @DEC64 long one0, String msg) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private static void test_log(@DEC64 long zero, @DEC64 long nan, String msg) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    ...
    private static void test_sqrt(@DEC64 long input, @DEC64 long expected, String msg) {
        ...
        String outMsg = "sqrt(" + msg + ") was " + actual;

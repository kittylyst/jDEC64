...
public class TestMath64 {
  ...
  private static @DEC64 long epsilon;
  private static @DEC64 long almost_one;
  private static @DEC64 long almost_negative_one;
  private static @DEC64 long half;
  private static @DEC64 long cent;
  private static @DEC64 long negative_nine;
  private static @DEC64 long negative_minnum;
  private static @DEC64 long negative_maxint;
  private static @DEC64 long negative_maxnum;
  private static @DEC64 long negative_pi;
  ...
  private static void test_raise(
      @DEC64 long base, @DEC64 long power, @DEC64 long expected, String msg) {
    @DEC64 long actual = raise(base, power);
    String outMsg =
        "raise("
            + msg
            + ") was "
  ...
  private static void test_root(
      @DEC64 long first, @DEC64 long second, @DEC64 long expected, String msg) {
